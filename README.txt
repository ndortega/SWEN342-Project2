README for SWEN-342 Project 2
TSA Security Screening

External Frameworks:
    Akka Actor System Maven Dependency:
    <dependency>
        <groupId>com.typesafe.akka</groupId>
        <artifactId>akka-stream-contrib-mqtt_2.12</artifactId>
        <version>0.6</version>
    </dependency>
...
Compilation:
    ...
    Intellij:
        ...
        and put the above dependency in the pom.xml file.  Then copy the source files
        into a src folder.
